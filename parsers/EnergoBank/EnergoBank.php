...
class EnergoBank extends baseParser {
	public function Init() {
		...
		*/
		$this->fetchUrl('Rates', 'http://uk.energobank.com.ua/online-services/ex-rates');
	}
	...
	public function ParseRates($mdata=Array()) {
		...
		*/
		...
		$needPart = findData($pageCnt,'НБУ</th>', '</table>', 0, true);
