...
class NiBank extends baseParser {
	public function Init() {
		...
		*/
		$this->fetchUrl('Rates', 'http://nib-samara.ru/');
	}
	...
	public function ParseRates($mdata=Array()) {
		...
		*/
		...
		$data = findData($data, '<td class="kursiValyut">','</table>', 0, true);
		...
		$cnt = str_replace ('<td>USD</td></tr>','<td>USD</td>',$cnt);
		$cnt = str_replace ('<td>EUR</td></tr>','<td>EUR</td>',$cnt);
