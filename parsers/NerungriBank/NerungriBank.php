...
class NerungriBank  extends baseParser {
	public function Init() {
		...
		*/
		$this->fetchUrl('Rates', 'http://www.nerungribank.ru/');
	}
	...
	public function ParseRates($mdata=Array()) {
		...
		*/
		...
		$data = findData($data, '<div id="curse">','</tbody>', 0, true);
		$cnt = trim($data['data']);

		//Unifying tags & replacing special chars to symbols
