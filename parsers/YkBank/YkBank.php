...
class YkBank extends baseParser {
	public function Init() {
		...
		*/
		$this->fetchUrl('Rates', 'http://www.ykb.ru/');
	}
	...
	public function ParseRates($mdata=Array()) {
		...
		*/
		...
		$data = findData($data, '<TD width="100%"><TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>','</TABLE>', 0, true);
		$cnt = trim($data['data']);
