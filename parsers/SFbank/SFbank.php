...
class SFbank extends baseParser{
	public function Init (){
		...
		*/
		$this->fetchUrl ('rates', 'http://sf-bank.com.ua/ua/');
	}
	...
	public function ParseRates ($mdata=array()){
		...
		*/
		...
		$needPart = findData($pageCnt, '<table id="moneycourse_tbl" cellpadding="0" cellspacing="0" border="0">', '</table>', 0, true );
