...
class CreditEurope extends baseParser {
	public function Init() {
		...
		*/
		$this->fetchUrl('Rates', 'http://www.crediteurope.com.ua/sites/ua/uk/');
	}
	...
	public function ParseRates($mdata=Array()) {
		...
		*/
		...
		$data = findData($data, '<table border="0" class="exchange">', '</table>', 0, true);
		$cnt = trim($data['data']);
