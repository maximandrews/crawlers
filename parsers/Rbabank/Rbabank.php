...
class Rbabank extends baseParser {
	public function Init() {
		...
		*/
		$this->fetchUrl('Rates', 'http://www.rbabank.ru/');
	}
	...
	public function ParseRates($mdata=Array()) {
		...
		*/
		...
		$data = findData($data, '<table data-id="22"','</table>', 0, true); //marking the part of code for the first bank office
		$cnt = trim($data['data']);
