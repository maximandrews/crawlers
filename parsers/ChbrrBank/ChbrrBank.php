...
class ChbrrBank extends baseParser {
	public function Init() {
		...
		*/
		$this->fetchURL('Rates','http://chbrr.crimea.ua/');
	}
	...
	public function ParseRates($mdata=Array()) {
		...
		*/
		...
		$needPart = findData($pageCnt, '<td align="center"><strong>Продажа</strong></td>', '</table>', 0, true);
