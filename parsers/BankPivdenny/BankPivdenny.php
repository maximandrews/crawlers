...
class BankPivdenny extends baseParser{
	public function Init (){
		...
		*/
		$this->fetchUrl ('rates', 'http://bank.com.ua/');
	}
	...
	public function ParseRates ($mdata=array()){
		...
		*/
		...
		$needPart = findData($pageCnt, '<div class="kurs_top"><img src="img/kurs_top.jpg" alt="" /></div><table class="exchange_course" border="0">', '</tbody>', 0, true );
