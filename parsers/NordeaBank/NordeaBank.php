...
class NordeaBank extends baseParser {
	public function Init() {
		...
		*/
		$this->fetchUrl('Rates', 'http://www.nordea.ru/curr.php');
	}
	...
	public function ParseRates($mdata=Array()) {
		...
		*/
		...
		//Removing basic currency and minimal deal amount from symbol names
