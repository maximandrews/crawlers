...
class MRBank extends baseParser {
	public function Init() {
		...
		*/
		$this->fetchUrl('Rates', 'http://www.mbr.ru/');
	}
	...
	public function ParseRates($mdata=Array()) {
		...
		*/
		...
		$data = findData($data, '<table cellspacing="0" cellpadding="0" class="design" style="margin-top: 10px; width: auto; height: auto;">', '</td></tr></table></td><td></td>', 0, true);
		$data = findData($data['data'], '<table cellspacing="0" cellpadding="0" class="design" style="margin-top: 10px; width: auto; height: auto;">', '</table>', 0, true);
		$cnt = trim($data['data']);
