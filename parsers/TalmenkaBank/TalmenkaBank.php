...
class TalmenkaBank extends baseParser {
	public function Init() {
		...
		*/
		$this->fetchUrl('Rates', 'http://www.tb22.ru/');
	}
	...
	public function ParseRates($mdata=Array()) {
		...
		*/
		...
		$start = strpos($data, 'umi:field-name="anons"  umi:module="news">');
		$data = findData($data, '</th>','</tbody>', $start, true);
		$cnt = trim($data['data']);
