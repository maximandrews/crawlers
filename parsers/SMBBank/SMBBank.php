...
class SMBBank extends baseParser {
	public function Init() {
		...
		*/
		$this->fetchUrl('Rates', 'http://www.banksmb.ru/');
	}
	...
	public function ParseRates($mdata=Array()) {
		...
		*/
		...
		$data = findData($data, 'class="MsoTableGrid"','</table>', 0, true, false);
		$cnt = trim($data['data']);
