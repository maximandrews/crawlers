...
class BankFP extends baseParser {
	public function Init() {
		...
		*/
		$this->fetchURL('Rates','http://www.bank-fp.com.ua/');
	}
	...
	public function ParseRates($mdata=Array()) {
		...
		*/
		...
		$needPart = findData($pageCnt, ' <td width=\'94\' style=\'padding-right: 5px;\' class=\'text_focus\' align=\'right\' valign=\'top\'>', '</table>', 0, true);
