...
class UkrgasBank extends baseParser {
	...
	public function Init() {
		...
		*/
		$this->fetchUrl('Rates', 'http://ukrgasbank.com/ukr/currency/');
	}
	...
	public function ParseRates($mdata=Array()) {
		...
		*/
		...
		while(is_int($start) && $row = findData($cnt, '<tr>', '</tr>', $start, true)) {
			...
			// Passing by currency digital code
			$rstart = 0;
