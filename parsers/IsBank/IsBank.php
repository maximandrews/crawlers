...
class IsBank extends baseParser {
	public function Init() {
		...
		*/
		$this->fetchUrl('Rates', 'http://www.isbank.com.ru/2default-rus.shtml');
	}
	...
	public function ParseRates($mdata=Array()) {
		...
		*/
		...
		$data = findData($data, '<TABLE WIDTH="100%" BORDER=0 CELLSPACING=0 CELLPADDING=5>', '</table>', 0, true);
		$cnt = trim($data['data']);
