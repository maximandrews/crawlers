...
class UnicreditBank extends baseParser{
	public function Init (){
		...
		*/
		$this->fetchUrl ('rates', 'http://en.unicredit.com.ua/');
	}
	...
	public function ParseRates ($mdata=array()){
		...
		*/
		...
		$needPart = findData($cnt, '<td>Ask</td></tr></thead><tbody>', '<td class="strong linkss" colspan="3">', 0, true );
		...
		//removing "UAH" from symbol cells
		$cnt = str_ireplace('UAH/', '', $cnt);
