...
class MosoblBank extends baseParser {
	public function Init() {
		...
		*/
		$this->fetchUrl('Rates', 'http://mosoblbank.ru/');
	}
	...
	public function ParseRates($mdata=Array()) {
		...
		*/
		...
		$data = findData($data, '<th class="currency">','<p class="note">', 0, true);
		$cnt = trim($data['data']);
