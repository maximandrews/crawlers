...
class BtaBank extends baseParser {
	public function Init() {
		...
		*/
		$this->fetchUrl('Rates', 'http://btabank.ua/rus/main.php');
	}
	...
	public function ParseRates($mdata=Array()) {
		...
		*/
		...
		$data = findData($data, '<div class="blk curr">','</table>', 0, true);
		$cnt = trim($data['data']);
