...
class KedrBank extends baseParser {
	public function Init() {
		...
		*/
		$this->fetchUrl('Rates', 'http://kedrbank.com/');
	}
	...
	public function ParseRates($mdata=Array()) {
		...
		*/
		...
		$data = findData($data, '<table id="curs">','Au', 0, true);
		$cnt = trim($data['data']);
		...
		//Replacing currency visual symbol
		$cnt = str_replace('$', 'USD', $cnt);
		$cnt = str_replace('€', 'EUR', $cnt);

		//Removing an empty cell
