...
class KDBank extends baseParser {
	public function Init() {
		...
		*/
		$this->fetchUrl('Rates', 'http://www.clhs.kiev.ua/');
	}
	...
	public function ParseRates($mdata=Array()) {
		...
		*/
		...
		$data = findData($data, '<table width="100%" border="0" cellspacing="1" cellpadding="3">', '</table>', 0, true);
