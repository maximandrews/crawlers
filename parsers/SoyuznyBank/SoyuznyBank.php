...
class SoyuznyBank extends baseParser {
	public function Init() {
		...
		*/
		$this->fetchUrl('Rates', 'http://www.soyuzny.ru/');
	}
	...
	public function ParseRates($mdata=Array()) {
		...
		*/
		...
		$data = findData($data, '<table class=CurrView','</div>', 0, true);
		$cnt = trim($data['data']);
		//Removing spacing near the symbol
		$cnt = str_replace(' : &nbsp;','',$cnt);
