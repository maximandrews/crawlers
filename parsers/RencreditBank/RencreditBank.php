...
class RencreditBank extends baseParser {
	public function Init() {
		...
		*/
		$this->fetchUrl('Rates', 'http://svc.rencredit.com.ua/calcsvcwwwrccfua/CurrExchangeForm.aspx?domain=rencredit.com.ua');
	}
	...
	public function ParseRates($mdata=Array()) {
		...
		*/
		...
		$data = findData($data, '<body>','</body>', 0, true, false);
		$cnt = trim($data['data']);
