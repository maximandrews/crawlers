...
class LenoblBank extends baseParser {
	public function Init() {
		...
		*/
		$this->fetchUrl('Rates', 'http://www.lenoblbank.ru/');
	}
	...
	public function ParseRates($mdata=Array()) {
		...
		*/
		...
		$data = findData($data, '<span style="font-size:10px;color: #ffffff;text-shadow:1px 1px 1px #999;">Продажа</span>','<td colspan="4" style="padding:0;">', 0, true);
		$cnt = trim($data['data']);
