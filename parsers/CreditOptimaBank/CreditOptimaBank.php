...
class CreditOptimaBank extends baseParser {
	public function Init() {
		...
		*/
		$this->fetchUrl('Rates', 'http://www.credit-optima.com.ua/ukr/about/');
	}
	...
	public function ParseRates($mdata=Array()) {
		...
		*/
		...
		$cnt = preg_replace("/<\/?(p|strong)[^>]*>/is", '', $cnt);
		$cnt = str_replace('<td>USD','<tr><td>USD',$cnt);
