...
class SichBank extends baseParser{
	public function Init (){
		...
		*/
		$this->fetchUrl ('rates', 'http://www.sichbank.com.ua/');
	}
	...
	public function ParseRates ($mdata=array()){
		...
		*/
		...
		$needPart = findData($pageCnt, '<td width=\'94\' style=\'border-bottom: 1px solid #b79865;border-left: 1px solid #b79865;\' class=\'text_focus\' align=\'right\' valign=\'top\'>', '</table>', 0, true );
