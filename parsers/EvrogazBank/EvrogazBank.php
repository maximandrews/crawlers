...
class EvrogazBank extends baseParser {
	public function Init() {
		...
		*/
		$this->fetchUrl('Rates', 'http://www.egb.kiev.ua/');
	}
	...
	public function ParseRates($mdata=Array()) {
		...
		*/
		...
		$data = findData($data, "<td class='bottomRateDate' align='left' valign='top'>", '</table>', 0, true);
		$cnt = trim($data['data']);
