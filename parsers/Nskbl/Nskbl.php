...
class Nskbl extends baseParser {
	public function Init() {
		...
		*/
		$this->fetchUrl('Rates', 'http://www.nskbl.ru/');
	}
	...
	public function ParseRates($mdata=Array()) {
		...
		*/
		...
		$data = findData($data, '<table cellpadding="0" cellspacing="0" border="0" ','<tr style', 0, true);
