...
class TetrapolisBank extends baseParser {
	public function Init() {
		...
		*/
		$this->fetchUrl('Rates', 'http://www.tetrapolis.ru/');
	}
	...
	public function ParseRates($mdata=Array()) {
		...
		$data = findData($data, '<table cellspacing="0" cellpadding="0">','</table>', 0, true);
		$cnt = trim($data['data']);
