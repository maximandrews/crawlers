...
class UnexBank extends baseParser {
	public function Init() {
		...
		*/
		$this->fetchUrl('Rates', 'http://unexbank.ua/site/valute_drag.php?lang=UA');
	}
	...
	public function ParseRates($mdata=Array()) {
		...
		*/
		...
		$data = findData($data, 'Валюта','invest moneta start', 0, true);
		$cnt = trim($data['data']);
