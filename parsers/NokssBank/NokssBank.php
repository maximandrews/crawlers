...
class NokssBank extends baseParser {
	public function Init() {
		...
		*/
		$this->fetchUrl('Rates', 'http://www.nokss.ru/');
	}
	...
	public function ParseRates($mdata=Array()) {
		...
		*/
		...
		$data = findData($data, '<font face="Tahoma" size="1" color="#1F3A80">','colspan="3" align="center"', 0, true);
		$cnt = trim($data['data']);
