...
class AccordBank extends baseParser {
	public function Init() {
		...
		*/
		$this->fetchUrl('Rates', 'http://www.accordbank.com.ua/');
	}
	...
	public function ParseRates($mdata=Array()) {
		...
		*/
		...
		$cnt = str_replace('Англійський фунт стерлінгів','GBP',$cnt);
		$cnt = str_replace('Швейцарський франк','CHF',$cnt);
		$cnt = str_replace('Шведська крона','SEK',$cnt);
