...
class DNBBank extends baseParser {
	public function Init() {
		...
		*/
		$this->fetchUrl('Rates', 'https://www.dnb.lv/lv/privatpersonam');
	}
	...
	public function ParseRates($mdata=Array()) {
		...
		*/
		...
		$data = findData($data, '<table id="curr_block" class="rates_small_content">','</table>', 0, true);
		$cnt = trim($data['data']);
