...
class FundServiceBank extends baseParser {
	public function Init() {
		...
		*/
		$this->fetchUrl('Rates', 'http://www.fundservice.ru/chastnym_licam');
	}
	...
	public function ParseRates($mdata=Array()) {
		...
		*/
		...
		$data = findData($data, '<table class="default" id="slide">', '</table>', 0, true);
		$cnt = trim($data['data']);
