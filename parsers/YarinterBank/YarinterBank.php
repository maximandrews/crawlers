...
class YarinterBank extends baseParser {
	public function Init() {
		...
		*/
		$this->fetchUrl('Rates', 'http://www.yarinterbank.ru/private/currency-exchange/');
	}
	...
	public function ParseRates($mdata=Array()) {
		...
		*/
		...
		$data = findData($data, '<table class="b-currencies">','</table>', 0, true);
		$cnt = trim($data['data']);
