...
class KRBank extends baseParser {
	public function Init() {
		...
		*/
		$this->fetchUrl('Rates', 'http://www.kruss.kiev.ua/');
	}
	...
	public function ParseRates($mdata=Array()) {
		...
		*/
		...
		$data = findData($data, '<table width="100%" cellspacing="0" cellpadding="0" border="0"><tbody>', '</table></div></div>', 0, true);
		$cnt = trim($data['data']);
