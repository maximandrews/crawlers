...
class BankRadian extends baseParser {
	public function Init() {
		...
		*/
		$this->fetchUrl('Rates', 'http://www.radian.ru/');
	}
	...
	public function ParseRates($mdata=Array()) {
		...
		*/
		...
		$data = findData($data, '<div class="b-currency-table-inner">','</div>', 0, true);
		$cnt = iconv('windows-1251', 'UTF-8', trim($data['data']));

		//Unifying tags
		$cnt = trim(strip_tags($cnt, '<li><ul>'));
