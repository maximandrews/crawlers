...
class Ebrf extends baseParser {
	public function Init() {
		...
		*/
		$this->fetchUrl('Rates', 'http://www.ebrf.com.ua/');
	}
	...
	public function ParseRates($mdata=Array()) {
		...
		*/
		...
		$data = findData($data, "<table width=200 cellspacing=0 cellpadding=3 class='cnt'>", '</table>', 0, true);
		$cnt = trim($data['data']);
